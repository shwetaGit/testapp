...
public class ContactTypeTestCase extends EntityTestCriteria {
    ...
    private ContactType createContactType(Boolean isSave) throws Exception {
        ...
        contacttype.setContactTypeIcon("5KvkVZnBH3Uwd6GQwweVCVvxKyd0xDEK9kdRATwJLDTCQGOU06");
        contacttype.setContactType("tiRlkspCaDGDteaE83KuzLc9xAXaAaqrJUQ8Mwmg0B3zQpFQJC");
        contacttype.setContactTypeDesc("8mTFglO67Bqr8sIXHS2OFMl3u4bfdhPoqn1QL50CGXJAdjIL5e");
    ...
    public void test2Update() {
        try {
            ...
            contacttype.setContactTypeIcon("iqdQSWBgCxC5rh3VqPMiuQboQoN6YMIsq3oNuwLmmXVAeDseev");
            contacttype.setContactType("VoBUUF66ohIaZn4bTwEdvkGOztyGBAc70m32ljthBxzZwsPXcn");
            contacttype.setContactTypeDesc("StfC9oSch35T9wNSOMYaY4hTBnHLp1x6pcOYXMXc8OFlTnWyIy");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 2, "contactType", "LKo4m3CIyKeaj2Wt1efOSBKoMF2CO7dkr6xOBVSzy4VnU1ntB8OCw751VRjqnQ4GoL8bGQvs3eddquIaDvCRohIM1eypblrAzl6B7Am4euBdZo5HWM2ezEuFfFlqUa87H"));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 3, "contactTypeDesc", ""));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 4, "contactTypeIcon", "bYY7XikLV9Rk5OE8WOLDQtTnfyzIQEqlWKseOgj4eGZR4zTXrFnJPtjvOI5VowydJymhf21Bqb8MTcb3ZXu8bkRzw4WNelIzLYAouqRzlzF9wZZvwGR3oBMPc5uPOIxy5"));
