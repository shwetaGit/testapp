Ext.define('Appmob.appmob.web.com.controller.organization.contactmanagement.TitleMainController', {
     ...
     setGridConfig: function() {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Appmob.appmob.shared.com.model.organization.contactmanagement.TitleModel',
               autoLoad: {
                    params: {
