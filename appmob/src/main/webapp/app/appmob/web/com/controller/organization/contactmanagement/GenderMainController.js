Ext.define('Appmob.appmob.web.com.controller.organization.contactmanagement.GenderMainController', {
     ...
     setGridConfig: function() {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Appmob.appmob.shared.com.model.organization.contactmanagement.GenderModel',
               autoLoad: {
                    params: {
