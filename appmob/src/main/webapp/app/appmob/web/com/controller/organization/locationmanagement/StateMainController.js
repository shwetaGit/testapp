Ext.define('Appmob.appmob.web.com.controller.organization.locationmanagement.StateMainController', {
     ...
     setGridConfig: function() {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Appmob.appmob.shared.com.model.organization.locationmanagement.StateModel',
               autoLoad: {
                    params: {
