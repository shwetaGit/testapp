Ext.define('Appmob.appmob.web.com.controller.organization.locationmanagement.CityMainController', {
     ...
     setGridConfig: function() {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Appmob.appmob.shared.com.model.organization.locationmanagement.CityModel',
               autoLoad: {
                    params: {
