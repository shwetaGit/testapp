Ext.define('Appmob.appmob.web.com.controller.organization.locationmanagement.CountryMainController', {
     ...
     setGridConfig: function() {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Appmob.appmob.shared.com.model.organization.locationmanagement.CountryModel',
               autoLoad: {
                    params: {
