Ext.define('Appmob.appmob.web.com.controller.organization.locationmanagement.AddressTypeMainController', {
     ...
     setGridConfig: function() {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Appmob.appmob.shared.com.model.organization.locationmanagement.AddressTypeModel',
               autoLoad: {
                    params: {
