Ext.define('Appmob.appmob.web.com.controller.organization.contactmanagement.ContactTypeMainController', {
     ...
     setGridConfig: function() {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Appmob.appmob.shared.com.model.organization.contactmanagement.ContactTypeModel',
               autoLoad: {
                    params: {
