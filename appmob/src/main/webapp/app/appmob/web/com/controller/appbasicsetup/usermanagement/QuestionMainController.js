Ext.define('Appmob.appmob.web.com.controller.appbasicsetup.usermanagement.QuestionMainController', {
     ...
     setGridConfig: function() {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Appmob.appmob.shared.com.model.appbasicsetup.usermanagement.QuestionModel',
               autoLoad: {
                    params: {
