Ext.define('Appmob.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Appmob.view.usermanagement.admin.UserPasswordReset',
	            'Appmob.view.usermanagement.admin.AddUserDetails',
	            'Appmob.view.usermanagement.admin.ViewUser'],
