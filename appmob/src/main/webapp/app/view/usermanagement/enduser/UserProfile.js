Ext.define('Appmob.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Appmob.view.usermanagement.enduser.UserProfileController', 'Appmob.view.usermanagement.admin.AddUserDetailsViewModel', 'Appmob.model.AddUserDataModel' ],
