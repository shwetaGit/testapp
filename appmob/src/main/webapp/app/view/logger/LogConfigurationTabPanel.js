...
Ext
		.define(
				'Appmob.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Appmob.view.logger.tabs.details.DetailsTab',
							'Appmob.view.logger.tabs.fileconnector.FileConnectorTab',
							'Appmob.view.logger.tabs.dbconnector.DBConnectorTab',
							'Appmob.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Appmob.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Appmob.view.logger.LogConfigurationTabPanelController',
