 ...
 * 
 */
Ext.define('Appmob.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Appmob.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
