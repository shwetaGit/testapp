Ext.define("Appmob.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Appmob.view.clouddrive.CloudDriveController',
	             'Appmob.view.clouddrive.documentview.DocumentsView',
	             'Appmob.view.clouddrive.drivedetails.DriveDetails',
	             //'Appmob.view.clouddrive.documentview.DocumentListView'
	             ],
