 ...
 * 
 */
Ext.define('Appmob.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Appmob.view.securityconfig.SecurityConfigController',
			'Appmob.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
