Ext
		.define(
				'Appmob.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Appmob.view.searchengine.search.SearchEngineMainPanelController','Appmob.view.searchengine.search.PanelHeaderField' ,'Appmob.view.searchengine.search.ReportGridView','Appmob.view.searchengine.search.ReportChartView','Appmob.view.searchengine.search.documentView','Appmob.view.searchengine.search.DouMeanView','Appmob.view.googlemaps.map.MapPanel'],
