...
public class ADAuthBusinessService implements PluggableAuthConnector {
	...
	public ADAuthBusinessService(final HashMap<String, String> properties) throws Exception {
		String domain = "";
		String url = "";
		if (properties == null) {
	...
	public boolean authenticate(final LoginCredentials loginBean) throws BaseSecurityException {
		...
		final Authentication authentication = new UsernamePasswordAuthenticationToken(loginBean.getLoginId(), loginBean.getPassword());
		try {
	...
	public boolean reAuthenticate(final TokenCredential tokenBean) throws BaseSecurityException {
		...
		try {
			...
			final Authentication authentication = new UsernamePasswordAuthenticationToken(userAuthentication.getLoginId(), tokenBean.getTokenCredentials());
	 ...
	 */
	private boolean checkUserAthentication(final UserAuthentication userAuthentication, final String password, final Authentication authentication) throws AppBaseException {
