...
@NamedQueries({ @javax.persistence.NamedQuery(name = "SessionData.FindBySessionKey", query = "select e from SessionData e where e.appSessionId=:appSessionId and e.sessionKey =:sessionKey AND e.systemInfo.activeStatus=1"), @javax.persistence.NamedQuery(name = "SessionData.DeleteAllSessionData", query = "delete from SessionData e where e.appSessionId=:appSessionId AND e.systemInfo.activeStatus=1"), @javax.persistence.NamedQuery(name = "SessionData.FindByAppSessionId", query = "select e from SessionData e where e.appSessionId=:appSessionId AND e.systemInfo.activeStatus=1") })
public class SessionData implements Serializable, CommonEntityInterface, SessionDataInterface, Comparator<SessionData> {

    private static final long serialVersionUID = 1482410111946L;
