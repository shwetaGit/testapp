...
public class LoginSession implements Serializable, CommonEntityInterface, LoginSessionInterface, Comparator<LoginSession> {
    ...
    private static final long serialVersionUID = 1482410110537L;
    ...
    public LoginSession(String appSessionId, String userId, String userdetailAuthAlgo, String appServerSessionId, Timestamp loginTime, Timestamp lastAccessTime, Timestamp logoutTime, String clientIPAddress, Long clientIPAddressInt, Integer clientNetworkAddress, String clientBrowser, String sessionData) {
