...
import {BASIC_WIDGETSTYLE_CLASS, NUMBER_INPUT_PREFIX} from "../style.constants";
...
export class NumberInput implements OnInit,AfterViewInit,ControlValueAccessor{
    ...
    @Input()    widgetConfig    :   NumberInputConfiguration;
    ...
    ngOnInit(){
        ...
        this.elementId =  NUMBER_INPUT_PREFIX+Math.floor(Math.random()*90000) + 10000;
