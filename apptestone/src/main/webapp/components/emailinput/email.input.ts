...
import {BASIC_WIDGETSTYLE_CLASS, EMAIL_INPUT_PREFIX} from "../style.constants";
...
export class EmailInput implements OnInit,AfterViewInit,ControlValueAccessor{
    ...
    @Input()    widgetConfig    :   EmailInputConfiguration;
    ...
    ngOnInit(){
        ...
        this.elementId = EMAIL_INPUT_PREFIX+Math.floor(Math.random()*90000) + 10000;
 ...
 */
export class EmailInputConfiguration{
    hidden : boolean;
    disabled : boolean;
    readOnly : boolean;
    required : boolean;
